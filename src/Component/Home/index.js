    ...
    <>
      <div className='home-container'>
        ...
        <div className='crative'>
          <Slider {...settings}>
            <div>
              <img src={`${process.env.PUBLIC_URL}/images/home-slider/00-Research.svg`} />   
            </div>
            <div>
              <img src={`${process.env.PUBLIC_URL}/images/home-slider/01-User_Persona.svg`} />   
            </div>
            <div>
              <img src={`${process.env.PUBLIC_URL}/images/home-slider/02-Information_Architecture.svg`} />   
            </div>
            <div>
              <img src={`${process.env.PUBLIC_URL}/images/home-slider/03-Wireframing_and_Prototyping.svg`} />   
            </div>
            <div>
              <img src={`${process.env.PUBLIC_URL}/images/home-slider/04-Usability_Testing.svg`} />   
            </div>
            <div>
              <img src={`${process.env.PUBLIC_URL}/images/home-slider/05-Iteration_and_Refinement.svg`} />   
            </div>
            <div>
              <img src={`${process.env.PUBLIC_URL}/images/home-slider/06-Visual_Design.svg`} />   
            </div>
            <div>
              <img src={`${process.env.PUBLIC_URL}/images/home-slider/07-Collaboration.svg`} />   
            </div>
            <div>
              <img src={`${process.env.PUBLIC_URL}/images/home-slider/08-Launch_and_Evaluation.svg`} />   
            </div>
          </Slider>
        </div>
        <div className='navigation-section'>
          <ul>
            <li className='link-style-1'>
              ...
              to={'/portfolio/resume'} >Resume</NavLink>
            </li>
            ...
            <li className='link-style-3'>
              ...
              style={{backgroundSize: `${percentageStyle3}%`}}
               to={'/portfolio/web-design'} >Web Design</NavLink>
            </li>
            ...
            <li className='link-style-5'>
              ...
              to={'/portfolio/app-design'} >App Design</NavLink>
            </li>
            <li className='link-style-6'>
              ...
              to={'/portfolio/contact'} >Contact</NavLink>
            </li>
            <li className='link-style-7'>
              ...
              to={'/portfolio'} >Illustrator</NavLink>
            </li>
            ...
            <li className='link-style-9'>
              ...
              to={'/portfolio'} >Creatives</NavLink>
            </li>
